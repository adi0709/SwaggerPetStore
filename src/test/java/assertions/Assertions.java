...
public class Assertions {
    ...
    public static void createPetAssertions(Response createPetResponse, PetData petPayload, String path) {
        ...
        Assert.assertEquals(createPetResponse.jsonPath().get("status"), petPayload.getStatus().toString());
    ...
    public static void getPetsByStatusAssertions(Response getPetByStatusResponse, String path, PetStatus status) {
        for (int i = 0; i < getPetByStatusResponse.jsonPath().getList("status").size(); i++) {
            Assert.assertEquals(getPetByStatusResponse.jsonPath().getList("status").get(i).toString(), status.toString());
        }
    ...
    public static void updatePetAssertions(Response updatePetResponse, PetData petPayload, String path) {
        ...
        Assert.assertEquals(updatePetResponse.jsonPath().get("status"), petPayload.getStatus().toString());
